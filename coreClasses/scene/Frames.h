...
template<typename ObjState> template<typename UpdatableObj> std::unique_ptr <Frames <ObjState> > Frames <ObjState>
::genFrames (const UpdatableObj& object) {
...
template<typename ObjState> template<typename UpdatableObj,
                                     typename ChildState> std::unique_ptr <Frames <ObjState> > Frames <ObjState>
::genFrames (
    const UpdatableObj& object) {
