...
template<typename BaseType, typename FrameType> class Mesh {
...
template<typename BaseType, typename FrameType> Mesh <BaseType, FrameType>::Mesh(const BaseType& base):
    _base(base),
    _frame(base),
    _components(
...
template<typename BaseType, typename FrameType> vecMeshComponent_sptr Mesh <BaseType,
                                                                            FrameType>::getAnimatedComponents
    (vecMeshComponent_sptr components) {
...
template<typename BaseType, typename FrameType> const glm::mat4& Mesh <BaseType, FrameType>::world() const {
    return _world;
}

template<typename BaseType, typename FrameType> void Mesh <BaseType, FrameType>::render (
...
template<typename BaseType, typename FrameType> const FrameType& Mesh <BaseType,
                                                                       FrameType>::getInstanceFrame() const {
    return _frame;
}

template<typename BaseType, typename FrameType> const BaseType& Mesh <BaseType, FrameType>::getBase() const {
    return _base;
}

template<typename BaseType, typename FrameType> void Mesh <BaseType, FrameType>::setWorld (
