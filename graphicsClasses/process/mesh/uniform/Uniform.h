...
class Uniform : public UniformBase {
   public:
    Uniform(const T& value, const ShaderProgram_uptr& shaderProgram, const std::string& name);
...
template <class T>
Uniform<T>::Uniform(const T& value, const ShaderProgram_uptr& shaderProgram, const std::string& name)
    : UniformBase(shaderProgram, name), _value(value) {}
