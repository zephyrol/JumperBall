...
${OBJECTDIR}/graphicsClasses/Rendering.o: graphicsClasses/Rendering.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/Rendering.o graphicsClasses/Rendering.cpp

${OBJECTDIR}/graphicsClasses/Shader.o: graphicsClasses/Shader.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/Shader.o graphicsClasses/Shader.cpp

${OBJECTDIR}/graphicsClasses/ShaderProgram.o: graphicsClasses/ShaderProgram.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/ShaderProgram.o graphicsClasses/ShaderProgram.cpp

${OBJECTDIR}/graphicsClasses/Star.o: graphicsClasses/Star.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/Star.o graphicsClasses/Star.cpp

${OBJECTDIR}/graphicsClasses/Utility.o: graphicsClasses/Utility.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/Utility.o graphicsClasses/Utility.cpp
...
${OBJECTDIR}/graphicsClasses/uniformBlocks/uniformLight.o: graphicsClasses/uniformBlocks/uniformLight.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses/uniformBlocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/uniformBlocks/uniformLight.o graphicsClasses/uniformBlocks/uniformLight.cpp
