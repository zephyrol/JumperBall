...
${OBJECTDIR}/coreClasses/Ball.o: coreClasses/Ball.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/Ball.o coreClasses/Ball.cpp

${OBJECTDIR}/coreClasses/ClassicalMechanics.o: coreClasses/ClassicalMechanics.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/ClassicalMechanics.o coreClasses/ClassicalMechanics.cpp

${OBJECTDIR}/coreClasses/Map.o: coreClasses/Map.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/Map.o coreClasses/Map.cpp

${OBJECTDIR}/coreClasses/Types.o: coreClasses/Types.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/Types.o coreClasses/Types.cpp

${OBJECTDIR}/coreClasses/blocks/BaseBlock.o: coreClasses/blocks/BaseBlock.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses/blocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/blocks/BaseBlock.o coreClasses/blocks/BaseBlock.cpp

${OBJECTDIR}/coreClasses/blocks/Block.o: coreClasses/blocks/Block.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses/blocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/blocks/Block.o coreClasses/blocks/Block.cpp

${OBJECTDIR}/coreClasses/blocks/BrittleBlock.o: coreClasses/blocks/BrittleBlock.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses/blocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/blocks/BrittleBlock.o coreClasses/blocks/BrittleBlock.cpp

${OBJECTDIR}/coreClasses/blocks/FireBlock.o: coreClasses/blocks/FireBlock.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses/blocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/blocks/FireBlock.o coreClasses/blocks/FireBlock.cpp

${OBJECTDIR}/coreClasses/blocks/IceBlock.o: coreClasses/blocks/IceBlock.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses/blocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/blocks/IceBlock.o coreClasses/blocks/IceBlock.cpp

${OBJECTDIR}/coreClasses/blocks/JumpBlock.o: coreClasses/blocks/JumpBlock.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses/blocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/blocks/JumpBlock.o coreClasses/blocks/JumpBlock.cpp
...
${OBJECTDIR}/coreClasses/objects/Bonus.o: coreClasses/objects/Bonus.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/objects/Bonus.o coreClasses/objects/Bonus.cpp

${OBJECTDIR}/coreClasses/objects/Clock.o: coreClasses/objects/Clock.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses/objects
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/objects/Clock.o coreClasses/objects/Clock.cpp

${OBJECTDIR}/coreClasses/objects/Coin.o: coreClasses/objects/Coin.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses/objects
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/objects/Coin.o coreClasses/objects/Coin.cpp

${OBJECTDIR}/coreClasses/objects/Key.o: coreClasses/objects/Key.cpp
	${MKDIR} -p ${OBJECTDIR}/coreClasses/objects
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coreClasses/objects/Key.o coreClasses/objects/Key.cpp
...
${OBJECTDIR}/graphicsClasses/Camera.o: graphicsClasses/Camera.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/Camera.o graphicsClasses/Camera.cpp

${OBJECTDIR}/graphicsClasses/FrameBuffer.o: graphicsClasses/FrameBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/FrameBuffer.o graphicsClasses/FrameBuffer.cpp
...
${OBJECTDIR}/graphicsClasses/MeshGenerator.o: graphicsClasses/MeshGenerator.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/MeshGenerator.o graphicsClasses/MeshGenerator.cpp

${OBJECTDIR}/graphicsClasses/Rendering.o: graphicsClasses/Rendering.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/Rendering.o graphicsClasses/Rendering.cpp

${OBJECTDIR}/graphicsClasses/Shader.o: graphicsClasses/Shader.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/Shader.o graphicsClasses/Shader.cpp

${OBJECTDIR}/graphicsClasses/ShaderProgram.o: graphicsClasses/ShaderProgram.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/ShaderProgram.o graphicsClasses/ShaderProgram.cpp

${OBJECTDIR}/graphicsClasses/Star.o: graphicsClasses/Star.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/Star.o graphicsClasses/Star.cpp

${OBJECTDIR}/graphicsClasses/Utility.o: graphicsClasses/Utility.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/Utility.o graphicsClasses/Utility.cpp
...
${OBJECTDIR}/graphicsClasses/animations/Animation.o: graphicsClasses/animations/Animation.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/animations/Animation.o graphicsClasses/animations/Animation.cpp

${OBJECTDIR}/graphicsClasses/animations/BallAnimation.o: graphicsClasses/animations/BallAnimation.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses/animations
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/animations/BallAnimation.o graphicsClasses/animations/BallAnimation.cpp

${OBJECTDIR}/graphicsClasses/animations/ObjectAnimation.o: graphicsClasses/animations/ObjectAnimation.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses/animations
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/animations/ObjectAnimation.o graphicsClasses/animations/ObjectAnimation.cpp

${OBJECTDIR}/graphicsClasses/geometry/Cube.o: graphicsClasses/geometry/Cube.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses/geometry
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/geometry/Cube.o graphicsClasses/geometry/Cube.cpp

${OBJECTDIR}/graphicsClasses/geometry/Cylinder.o: graphicsClasses/geometry/Cylinder.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses/geometry
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/geometry/Cylinder.o graphicsClasses/geometry/Cylinder.cpp

${OBJECTDIR}/graphicsClasses/geometry/GeometricShape.o: graphicsClasses/geometry/GeometricShape.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses/geometry
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/geometry/GeometricShape.o graphicsClasses/geometry/GeometricShape.cpp
...
${OBJECTDIR}/graphicsClasses/geometry/Sphere.o: graphicsClasses/geometry/Sphere.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses/geometry
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/geometry/Sphere.o graphicsClasses/geometry/Sphere.cpp

${OBJECTDIR}/graphicsClasses/testClass.o: graphicsClasses/testClass.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/testClass.o graphicsClasses/testClass.cpp
...
${OBJECTDIR}/graphicsClasses/uniformBlocks/uniformBlock.o: graphicsClasses/uniformBlocks/uniformBlock.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/uniformBlocks/uniformBlock.o graphicsClasses/uniformBlocks/uniformBlock.cpp

${OBJECTDIR}/graphicsClasses/uniformBlocks/uniformLight.o: graphicsClasses/uniformBlocks/uniformLight.cpp
	${MKDIR} -p ${OBJECTDIR}/graphicsClasses/uniformBlocks
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graphicsClasses/uniformBlocks/uniformLight.o graphicsClasses/uniformBlocks/uniformLight.cpp

${OBJECTDIR}/libs/glad/glad.o: libs/glad/glad.c
	${MKDIR} -p ${OBJECTDIR}/libs/glad
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilibs -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/glad/glad.o libs/glad/glad.c

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -IcoreClasses -Ilibs -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
